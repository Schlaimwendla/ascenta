...
% --- HINWEIS: Stelle sicher, dass \usepackage{tabularx} in deiner Präambel geladen ist! ---

\subsection{Liam Vendel}
Gesamtarbeitsaufwand: [XX] Stunden % Hier später die finale Zahl aus dem Excel eintragen

\vspace{1cm}
\begin{tabularx}{\textwidth}{l p{1cm} l p{1cm} X}
Braunau am Inn, \today & & Liam Vendel & & \hrulefill \\
\emph{Ort, Datum} & & & & \emph{Unterschrift} \vspace{2cm}\\ 
\end{tabularx}

\subsection{Manuel Zauner}
Gesamtarbeitsaufwand: [XX] Stunden % Hier später die finale Zahl aus dem Excel eintragen

\vspace{1cm}
\begin{tabularx}{\textwidth}{l p{1cm} l p{1cm} X}
Braunau am Inn, \today & & Manuel Zauner & & \hrulefill \\
\emph{Ort, Datum} & & & & \emph{Unterschrift} \vspace{2cm}\\ 
\end{tabularx}

\subsection{Fabian Lindlbauer}
Gesamtarbeitsaufwand: [XX] Stunden % Hier später die finale Zahl aus dem Excel eintragen

\vspace{1cm}
\begin{tabularx}{\textwidth}{l p{1cm} l p{1cm} X}
Braunau am Inn, \today & & Fabian Lindlbauer & & \hrulefill \\
\emph{Ort, Datum} & & & & \emph{Unterschrift} \vspace{2cm}\\ 
\end{tabularx}