...
The technical framework utilizes the Arduino Nicla Vision microcontroller. The firmware implements the FOMO architecture for efficient on-device face detection. For user interaction, a local and privacy-oriented voice recognition system was developed using the \textbf{Vosk engine} within a custom Android application. Communication is established via an optimized UDP protocol to ensure low-latency data streaming between the wearable and the mobile device.
