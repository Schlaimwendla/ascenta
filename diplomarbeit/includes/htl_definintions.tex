...
\addtokomafont{subsubsection}{\fontsize{13}{15.6}\selectfont}
...
%	frame=single,                   		% adds a frame around the code
	...
	columns=flexible,						% flexible column width to avoid overfull boxes
	linewidth=\linewidth,					% ensure listing does not exceed text width
